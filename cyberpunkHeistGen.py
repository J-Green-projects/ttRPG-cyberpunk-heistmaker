...
while (True):
    ...
    # factor of 0.9-3.2~, as jobs get exponentially more involved ($1,500 - $27,900 using default reward and rounding values).
    reward = round((((difficulty/3)**2.25)*baseReward)/rewardRounding)*rewardRounding
